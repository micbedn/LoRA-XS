...
def main():
    ...
    peft_config = LoraConfig(
        ...
        rank_pattern = {
            ...
            "layer.0.attention.self.value": 1,
            "layer.1.attention.self.value": 2,
            "layer.2.attention.self.value": 3,
            "layer.3.attention.self.value": 4,
            "layer.4.attention.self.value": 5,
            "layer.5.attention.self.value": 6,
            "layer.6.attention.self.value": 7,
            "layer.7.attention.self.value": 8,
            "layer.8.attention.self.value": 9,
            "layer.9.attention.self.value": 10,
            "layer.10.attention.self.value": 11,
            "layer.11.attention.self.value": 12,

            "layer.0.attention.output.dense": 1,
            "layer.1.attention.output.dense": 2,
            "layer.2.attention.output.dense": 3,
            "layer.3.attention.output.dense": 4,
            "layer.4.attention.output.dense": 5,
            "layer.5.attention.output.dense": 6,
            "layer.6.attention.output.dense": 7,
            "layer.7.attention.output.dense": 8,
            "layer.8.attention.output.dense": 9,
            "layer.9.attention.output.dense": 10,
            "layer.10.attention.output.dense": 11,
            "layer.11.attention.output.dense": 12,

            "layer.0.output.dense": 1,
            "layer.1.output.dense": 2,
            "layer.2.output.dense": 3,
            "layer.3.output.dense": 4,
            "layer.4.output.dense": 5,
            "layer.5.output.dense": 6,
            "layer.6.output.dense": 7,
            "layer.7.output.dense": 8,
            "layer.8.output.dense": 9,
            "layer.9.output.dense": 10,
            "layer.10.output.dense": 11,
            "layer.11.output.dense": 12,
            },
