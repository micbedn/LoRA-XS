...
class ModelArguments:
    ...
    lora_rank: int = field(metadata={"help": "The rank (r) to be used for LoRA."})
    ...
    lora_alpha: float = field(
        default=16, metadata={"help": "multiplier (alpha) used for LoRA."}
    )
...
def main():
    ...
    peft_config = LoraConfig(
        ...
        rank_pattern = {
            ...
            "layer.0.attention.self.value": 12,
            "layer.1.attention.self.value": 11,
            "layer.2.attention.self.value": 10,
            "layer.3.attention.self.value": 9,
            "layer.4.attention.self.value": 8,
            "layer.5.attention.self.value": 7,
            "layer.6.attention.self.value": 6,
            "layer.7.attention.self.value": 5,
            "layer.8.attention.self.value": 4,
            "layer.9.attention.self.value": 3,
            "layer.10.attention.self.value": 2,
            "layer.11.attention.self.value": 1,

            "layer.0.attention.output.dense": 12,
            "layer.1.attention.output.dense": 11,
            "layer.2.attention.output.dense": 10,
            "layer.3.attention.output.dense": 9,
            "layer.4.attention.output.dense": 8,
            "layer.5.attention.output.dense": 7,
            "layer.6.attention.output.dense": 6,
            "layer.7.attention.output.dense": 5,
            "layer.8.attention.output.dense": 4,
            "layer.9.attention.output.dense": 3,
            "layer.10.attention.output.dense": 2,
            "layer.11.attention.output.dense": 1,

            "layer.0.output.dense": 12,
            "layer.1.output.dense": 11,
            "layer.2.output.dense": 10,
            "layer.3.output.dense": 9,
            "layer.4.output.dense": 8,
            "layer.5.output.dense": 7,
            "layer.6.output.dense": 6,
            "layer.7.output.dense": 5,
            "layer.8.output.dense": 4,
            "layer.9.output.dense": 3,
            "layer.10.output.dense": 2,
            "layer.11.output.dense": 1,
            },
    ...
    def log_trainable_parameters(model, tb_writer):
        ...
        tb_writer.add_text(
            "non_classifier_trainable_params", str(non_classifier_trainable_params), 0
        )
